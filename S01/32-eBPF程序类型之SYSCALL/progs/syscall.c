...
int bpf_prog(struct args *ctx)
{
	...
	static struct bpf_insn insns[] = {
		BPF_ST_MEM(BPF_DW, BPF_REG_10, -8, 0),  // *(u64 *)(r10 - 8) = 0
		BPF_MOV64_REG(BPF_REG_2, BPF_REG_10),   // r2 = r10
		BPF_ALU64_IMM(BPF_ADD, BPF_REG_2, -8),  // r2 += -8
		BPF_LD_MAP_FD(BPF_REG_1, 0),            // r1 = 0
		BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 0, 0, BPF_FUNC_map_lookup_elem), // BPF_FUNC_map_lookup_elem(r1, r2);
